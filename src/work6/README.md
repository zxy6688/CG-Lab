...
<p align="center">
  <img src="../../assets/work6/modelscope_workspace_outputs.png" alt="ModelScope Workspace Outputs" width="780">
</p>
...
<p align="center">
  <img src="../../assets/work6/modelscope_workspace_outputs.png" alt="Workspace Outputs" width="760">
</p>
...
可微渲染要求渲染结果对三维参数可导，使图像误差能够反向传播到顶点坐标、顶点颜色或纹理参数。对于第 `i` 个顶点：
...
高难度版本在剪影监督之外加入 RGB 图像监督。对于预测图像：
...
L_{\text{high}}
=
\lambda_{\text{sil}}L_{\text{silhouette}}
+
\lambda_{\text{rgb}}L_{\text{rgb}}
+
\lambda_{\text{reg}}L_{\text{regularization}}
$$
...
真实纹理拟合仍然基于 RGB Loss 和几何正则化。优化变量包括顶点偏移量和顶点颜色：
