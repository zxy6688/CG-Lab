...
| 分类 | 展示内容 | 对应位置 |
| --- | --- | --- |
| 基础任务 | 三维场景搭建：棋盘格地面、红色漫反射球、银色镜面球 | [查看任务 1 效果图](#section-6-1-3) |
| 基础任务 | 最大弹射次数变化：观察镜面反射内容随 `Max Bounces` 增加而变化 | [查看任务 2 动图](#section-6-2-3) |
| 基础任务 | 硬阴影效果：观察 shadow ray 遮挡判断后的地面投影 | [查看任务 3 效果图](#section-6-3-3) |
| 基础任务 | UI 交互效果：调节光源位置与最大弹射次数 | [查看任务 4 动图](#section-6-4-3) |
| 选做一 | 玻璃折射整体效果：透明材质、折射变形与环境反射 | [查看玻璃折射效果](#section-7-1-4) |
| 选做一 | 玻璃材质弹射次数变化：观察折射路径和透明感变化 | [查看玻璃弹射动图](#section-7-1-4) |
| 选做一 | Fresnel 边缘高光：观察玻璃球边缘反射增强效果 | [查看玻璃高光效果](#section-7-1-4) |
| 选做二 | MSAA 动态对比：观察采样数增加后边缘逐渐平滑 | [查看 MSAA 动图](#section-7-2-4) |
| 选做二 | 单采样与多采样对比：比较 `AA Grid = 1` 和 `AA Grid = 5` | [查看 MSAA 整体对比](#section-7-2-4) |
| 选做二 | 边缘局部放大：对比未开启 MSAA 与开启 MSAA 后的边缘差异 | [查看局部放大对比](#section-7-2-4) |
<a id="section-1"></a>
