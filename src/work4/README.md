...
该图能够观察到球体高光亮斑的边缘范围、圆锥侧面亮带的宽窄变化
...
球体和圆锥的阴影形状不同，光源位置变化后，阴影方向和长度也会随之变化
...
同时，为了让阴影效果真正明显，我还加入了地面平面作为接收阴影的表面。这样球体和圆锥的投影就能直接落到地面上，视觉效果远比只有悬浮物体更清楚，也更适合截图展示。
...
基础版能够正确表现球体与圆锥的明暗变化和镜面高光。其中球体高光分布较平滑，圆锥侧面则表现出沿几何方向展开的亮带。
